...
def get_sub_batchs(epoch, fg_train_nid, world_size, ntrain_per_gpu, graph, rank, split_fn, jp_times):
    ...
    current_part_id = partition_book.partid  # 在DGL中，rank通常对应partition id
    ...
    for row in reversed_useful_fg_train_nid:
        for batch in row:
            ...
            cur_gpu_nid_mask = (part_ids.numpy() == current_part_id)
